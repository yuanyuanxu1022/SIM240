...
int cvRun(bool closed)
{
  const std::string runId=closed
    ? "moving_control_volume_M2_closed_2000_v2_20260908"
    : "moving_control_volume_C_open_2000_v2_20260908";
  ...
  try {
    ...
    record<<"run_id="<<runId<<"\ncommand=mpirun -np 1 "
      <<"./explicit_piston_zouhe_moving_control_volume_longrun "
