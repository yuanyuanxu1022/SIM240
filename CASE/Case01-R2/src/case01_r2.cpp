...
constexpr T dt = 2.5e-12;
constexpr T targetTau = 1.7;
...
int main(int argc, char* argv[])
{
  ...
  if (mode == "precheck") {
    ...
    result << std::setprecision(17) << std::boolalpha
      << "run_scope=Case01_R2_dx2p5_tau1p7_precheck\n"
  ...
  record(0, initial);
  std::cout << "run_scope=Case01_R2_dx2p5_tau1p7_a1e5\n"
  ...
  std::ofstream result(outputDirectory / "result.txt");
  result << std::setprecision(17) << std::boolalpha
    << "run_scope=Case01_R2_dx2p5_tau1p7_a1e5\n"
